...
const projects = [
  ...
  },
  {
    ...
    description:
      "An omnimodal diffusion vision-language-action model unifying sensor integrated action generation, world modeling, goal-state prediction, and task understanding in one shared backbone.",
    status: "Released",
    statusStyle: "bg-emerald-400/20 text-emerald-300 border border-emerald-400/30",
    href: "https://dynin.ai/robotics/",
    external: true,
    gradient: "from-[#0f172a] via-[#1a2e1a] to-[#1c3028]",
    accentColor: "text-emerald-300",
    dotColor: "bg-emerald-400",
    arrowColor: "text-emerald-300 group-hover:text-white",

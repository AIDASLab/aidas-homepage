...
export const ROBOTS = [
  {
    ...
    specs: [
      ...
      { label: 'Actuators', value: 'Feetech STS3215 smart servos' },
      { label: 'Reach', value: '≈ 0.35 m' },
      { label: 'Payload', value: '≈ 0.25 kg' },
      { label: 'Mass', value: '≈ 1.0 kg' },
      { label: 'Control', value: 'Position control over TTL bus' },
    ],
    jointLabels: {
...
const SPEC_ROBOTS = [
  {
    ...
    specs: [
      { label: 'Degrees of freedom', value: '6 rotary joints (±360°)' },
      ...
      { label: 'Rating', value: 'IP54; 21 safety functions (PLd Cat.3)' },
    ],
  },
  {
    key: 'stationary-ai',
    ...
    specs: [
      ...
      { label: 'Reach per arm', value: '0.769 m' },
      { label: 'Arm weight', value: '4 kg each' },
      { label: 'Gripper', value: '0.04 m stroke, 100 N max force' },
  ...
  },
  {
    ...
    officialUrl: 'https://github.com/frankarobotics/franka_description',
    dof: '1',
    ...
    specs: [
      ...
      { label: 'Control', value: 'Prismatic finger pair' },
  ...
  },
  {
    ...
    dof: '4×6',
    tagline: 'Mobile ALOHA platform — four 6-DoF arms (2 leader + 2 follower) on a differential-drive Tracer base.',
    specs: [
      { label: 'Configuration', value: '4× 6-DoF arms on Tracer base' },
      { label: 'Arm payload', value: '1.5 kg rated (3 kg peak)' },
      { label: 'Arm reach', value: '509 mm' },
      { label: 'Base max speed', value: '1.6 m/s' },
      { label: 'Base payload', value: '100 kg' },
      { label: 'Runtime', value: '~4 hours' },
      { label: 'Sensors', value: '3 cameras + Orbbec DABAI depth (0.3–3 m)' },
    ],
  },
  {
    key: 'r1-lite',
    ...
    officialUrl: 'https://galaxea-dynamics.com/',
    dof: '23',
    tagline: 'Wheeled dual-arm mobile manipulator — two 6-axis A1X arms, 3-DoF lift torso, omnidirectional chassis.',
    specs: [
      { label: 'Total DoF', value: '23 (2×6 arms + 3 torso + 6 chassis + 2 grippers)' },
      { label: 'Arm payload', value: '3 kg @ 600 mm (5 kg max)' },
      { label: 'Arm reach', value: '600 mm' },
      { label: 'Vertical workspace', value: '0–1.7 m' },
      { label: 'Weight', value: '55 kg' },
      { label: 'Max chassis speed', value: '1.5 m/s (360° omnidirectional)' },
      { label: 'Battery', value: '48 V, 720 Wh; LiDAR + multi-cam + IMU' },
    ],
  },
  {
    key: 'metagloves-pro',
    ...
    officialUrl: 'https://www.manus-meta.com/metagloves-pro-haptic',
    dof: '25',
